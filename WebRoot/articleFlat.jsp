            ...
            <div class="jive-table">
              <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                ...
                for(Iterator<Article> it = articles.iterator();  it.hasNext(); ){
                	...
                	String classStr = lineNumber%2 ==0 ?"jive-even":"jive-odd";
                 ...
                 %>
                  <tr class="<%=classStr %>">
                   ...
                   <td class="jive-last" nowrap="nowrap" width="1%"><div class="jive-last-post">    <%=new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(a.getPdate())  %>   <br> 
                        by: <a href="http://bbs.chinajavaworld.com/thread.jspa?messageID=780182#780182" title="jingjiangjun" style="">KevinHu &#187;</a> </div></td>
                  </tr>
